...
var SettingsTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian2.Setting(containerEl).setName("Number of Color Bars").setDesc("Change number of color cells (You need to reload Obsidian for change to occur)").addText(
