...
![[Pasted image 20230620212135.png]]
...
A los hosts que tengamos a repartir, siempre tendremos que restarles 2, porque la primera será la **`Network IDE`** y la última la **`Broadcast Cast Address`**, y esas no nos interesan.
